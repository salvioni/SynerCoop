...
// Planos self-serve via Stripe Checkout.
// Enterprise é sob consulta (fluxo comercial manual), por isso não tem price aqui.
const PLAN_PRICES = {
...
router.post('/create-checkout', planExempt, authRequired, managerOnly, async (req, res, next) => {
  try {
    ...
    if (!priceId) throw badRequest('Plano inválido ou não configurado.');
